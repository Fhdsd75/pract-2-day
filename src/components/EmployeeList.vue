<template>
    <div class="table-container">
      ...
      <table class="employee-table">
        <thead>
          <tr>
            ...
            <th>Дата</th>
            <th>Дни</th>
            <th>З/п (без налогов)</th>
            <th>З/п (с налогами)</th>
            <th>Действия</th>
          </tr>
        </thead>
        <tbody>
          ...
          >
            ...
            <td>{{ calculateTaxedSalary(employee.salary) }}</td>
            <td>
      ...
      <div class="totals">
        <p><strong>Общая сумма без налогов:</strong> {{ totalSalary }}</p>
        <p><strong>Общая сумма с налогами (15%):</strong> {{ totalSalaryAfterTax }}</p>
      </div>
    </div>
  </template>
